        ...
        <div <?php post_class(); ?> >
            ...
            <div class="blog-page blog-item single row">
                ...
                <div class="uxb-col large-12 columns">
                    ...
                    <h1 class="blog-title" style="color:#5d8ecb !important;font-size:1.125em !important;"><?php the_title(); ?></h1>
                    ...
                    <?php
                        ...
                        if($override_with_theme_options) {
                            ...
                            $show_author_box = uxbarn_get_array_value(
                                                uxbarn_get_array_value(
                                                    get_post_meta($post->ID, 'uxbarn_post_single_post_element_display'), 0), 0);
                        }
                        ...
                        if($override_with_theme_options) {
                            ...
                            $show_tags = uxbarn_get_array_value(
                                                    uxbarn_get_array_value(
                                                        get_post_meta($post->ID, 'uxbarn_post_single_post_element_display'), 0), 1);
                        }
                    ...
                    <?php if($show_tags) : ?>
                        ...
                        <div id="tags-wrapper" class="blog-section">
                            <h4 class="blog-section-title" style="font-size:1.250em !important;">Tags</h4>
